...
def main():
    ...
    parser.add_argument('--outdir', type=str, default='train/test',
    ...
    parser.add_argument('--load', type=str, default='train')
    ...
    parser.add_argument('--always-keys', type=str, default=['attack'], nargs='*',
                        help='List of action keys, which should be always pressed throughout interaction with environment.')
    parser.add_argument('--reverse-keys', type=str, default=['forward'], nargs='*',
                        help='List of action keys, which should be always pressed but can be turn off via action.')
    parser.add_argument('--exclude-keys', type=str, default=['back', 'left', 'right', 'sneak', 'sprint'], nargs='*',
